        ...
        return(
            <View style={styles.fondo} >
                ...
                <View style={styles.fondoperfil}>
                    <TextInput
                        style={styles.InputPerfil} placeholder="Peso DeadLift "
                ...
                <View style={styles.fondoperfil}>
                    <TextInput
                        style={styles.InputPerfil} placeholder="Peso Back Squat "
                        placeholderTextColor="white"
                        name="BackSquat" 
                        keyboardType={'numeric'}  
                ...
                <TextInput
                    style={styles.InputPerfil} placeholder="Peso Shoulder Press "
                    placeholderTextColor="white"
                    name="ShoulderPress" 
                    keyboardType={'numeric'}  
                ...
                <TextInput
                    style={styles.InputPerfil} placeholder="Peso Clean&Jerk "
                    placeholderTextColor="white"
                    name="CleanJerk" 
                    keyboardType={'numeric'}  
                ...
                />
                <TextInput
                    style={styles.InputPerfil} placeholder="Peso Snatch "
                    placeholderTextColor="white"
                    name="Snatch" 
                    keyboardType={'numeric'}  
